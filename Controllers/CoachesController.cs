...
namespace Accelerated_Digital_Delivery_Coaching_Program.Controllers
{
    public class CoachesController : Controller
    {
        ...
        public CoachesController(AddDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CoachID,FirstName,LastName")] Coach coach)
        {
            if (ModelState.IsValid)
            {
                coach.CoachID = Guid.NewGuid();
                _context.Add(coach);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("CoachID,FirstName,LastName")] Coach coach)
        {
            if (id != coach.CoachID)
            {
                return NotFound();
